<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="relative">
            <select name="role_id" id="countries"
                class="py-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option selected>
                    Kamu sebagai apa ?
                </option>
        ...
        <div class="mt-4 relative">
            <div class="relative">
                <x-text-input id="email" class="w-full pl-10 pr-4 py-4 border border-gray-300 rounded-[12px]"
                ...
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                        ...
                        <path
                            ...
                            stroke="#807A7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M6.3138 3.20837H14.9561C16.2022 3.22235 17.3882 3.74914 18.2379 4.66606C19.0877 5.58298 19.5269 6.80998 19.4534 8.06132V14.0452C19.5269 15.2965 19.0877 16.5235 18.2379 17.4405C17.3882 18.3574 16.2022 18.8842 14.9561 18.8981H6.3138C3.63722 18.8981 1.83325 16.7207 1.83325 14.0452V8.06132C1.83325 5.38587 3.63722 3.20837 6.3138 3.20837Z"
                            stroke="#807A7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            </div>
        ...
        <div class="mt-4 relative">
            <div class="relative">
                <x-text-input id="password"
                    class="block mt-1 w-full pl-10 pr-4 py-4 border border-gray-300 rounded-[12px]" type="password"
                ...
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#807A7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M10.8743 13.0192V15.0551" stroke="#807A7A" stroke-width="1.5" stroke-linecap="round"
        ...
        <div class="d-block mt-4 md:w-auto xs:w-[271px] mx-auto">
            <x-primary-button
                class="w-full px-4 bg-green-600 hover:bg-green-700 relative rounded-[15px] focus:bg-green-700 active:bg-green-900 light:active:bg-green-300">
            ...
            <p class="text-center mt-[20px] mb-[38px] font-regular text-base text-[#120D26]">Sudah punya akun? <a
                    class="text-green-700" href="{{ route('login') }}">Punya dong!</a></p>
        </div>
    </form>
</x-guest-layout>
