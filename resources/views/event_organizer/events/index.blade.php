                ...
                <div class="bg-white light:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex justify-between">
                    ...
                    <div class="p-6 text-gray-900 light:text-gray-100">
                        <a href="{{ route('event.create') }}"
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Buat Acara</a>
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($events as $event)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <form action="{{ route('event.destroy', $event) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
