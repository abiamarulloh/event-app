    ...
    <div class="sm:ml-64">
        ...
        @if (Auth::user()->role_id === 1)
            <div class="py-2 max-w-7xl mx-auto sm:px-6 lg:px-8 rounded-lg mt-6 flex items-center gap-4">
                ...
                <h1 class="text-[25px] font-semibold text-gray-900">User Summary</h1>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 py-8">
                        <div class="flex items-center justify-between">
                            <h2 class="text-gray-900 font-bold text-[30px]">20</h2>
                            <div>
        ...
        <div class="py-2 max-w-7xl mx-auto sm:px-6 lg:px-8 rounded-lg mt-6 flex items-center gap-4">
            ...
            <h1 class="text-[25px] font-semibold text-gray-900">Event Summary</h1>
        </div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 rounded-lg">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 py-8">
                    <div class="flex items-center justify-between">
                        <h2 class="text-gray-900 font-bold text-[30px]">20</h2>
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Draft Acara</h2>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 py-8">
                    <div class="flex items-center justify-between">
                        <h2 class="text-gray-900 font-bold text-[30px]">20</h2>
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Acara On-Going</h2>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 py-8">
                    <div class="flex items-center justify-between">
                        <h2 class="text-gray-900 font-bold text-[30px]">20</h2>
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Acara Selesai</h2>
